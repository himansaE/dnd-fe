...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // Game UI themed trigger
        "flex w-full items-center justify-between gap-2 whitespace-nowrap",
        "rounded-xl border border-[#9361B0] bg-black/40 px-4 py-2.5 text-sm text-white",
        "outline-none focus:ring-2 focus:ring-[#a15ad0] shadow-xs disabled:cursor-not-allowed disabled:opacity-50",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          // Game UI themed popover
          "bg-black text-white border-[#9569AE] relative z-50 border-2 font-poppins",
